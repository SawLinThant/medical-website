...
const Footer:React.FC = () => {
    return(
        <footer className="w-full flex items-center justify-center p-4 flex-col bg-[url('/images/footer-background.jpg')] bg-cover bg-center">
            <div className="w-full min-h-[6rem] max-w-[1300px] grid lg:grid-cols-4 md:grid-cols-4 grid-cols-1 items-start justify-between gap-4 mt-12">
            ...
            <div className="w-full min-h-4 lg:mt-2 mt-4">
