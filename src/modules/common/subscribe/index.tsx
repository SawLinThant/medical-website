...
const Subscribe = () => {
    return(
        <div className="lg:w-full w-full md:w-2/5 lg:min-h-[23rem] md:min-h-[12rem] min-h-5 p-4 flex flex-col gap-4 bg-secondary_color/20 border rounded lg:mt-7">
          ...
          <form action="" className="w-full flex flex-col items-center gap-4 p-3 lg:pb-0 pb-8">
