...
import { FolderClosed, ImagePlus } from "lucide-react";
...
const FileuploadField: React.FC<FileuploadProps> = ({
  ...
  return <div className="h-full">
     <div
        ...
        onDrop={handleDrop}
        className={`${className} border-2 border-dashed flex flex-col items-center justify-center gap-2 p-6 rounded-lg text-center cursor-pointer transition-colors h-full ${
      ...
      >
        ...
        />
        <FolderClosed color="#b09696" size={22}/>
