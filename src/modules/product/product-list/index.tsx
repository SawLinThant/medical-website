...
const ProductList: React.FC<ProductListProps> = ({
  ...
  return (
    <div className="w-full flex flex-col mt-6">
      <div className="w-full flex flex-row min-h-28 items-center justify-between pb-4 border-b border-gray-300">
        ...
        <div className="min-w-32 flex flex-row items-center">
