...
`},73404:(e,s,r)=>{"use strict";r.a(e,async(e,t)=>{try{r.d(s,{A:()=>x});var l=r(5819),a=r(27466),i=r(89981),c=r(17133),d=r.n(c),o=r(43327);let e=async()=>{let e=await (0,o.v)();return e?.token||null},n=await e(),x=new l.R({ssrMode:!0,link:new a.P({uri:"https://api.natsay.com.mm/v1/graphql",fetch:d(),headers:{...n?{Authorization:`Bearer ${n}`}:{}}}),cache:new i.D});t()}catch(e){t(e)}},1)},64427:(e,s,r)=>{"use strict";r.d(s,{WF:()=>a});var t=r(94499);(0,t.J1)`
